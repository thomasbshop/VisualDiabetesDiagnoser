...
class Role(db.Model):
    ...
    def insert_roles():
        roles = {
            ...
            'Moderator': [Permission.UPLOAD, Permission.MODERATE],
            'Administrator': [Permission.UPLOAD, Permission.MODERATE,
                              Permission.ADMIN],
        }
        default_role = 'User'
        for r in roles:
...
class User(UserMixin, db.Model):
    ...
    def __init__(self, **kwargs):
        ...
        if self.role is None:
            if self.email == current_app.config['VISUAL_DIAGNOSER_ADMIN']:
...
image_schema = ImageProfileSchema()
