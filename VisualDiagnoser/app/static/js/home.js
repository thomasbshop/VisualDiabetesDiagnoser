...
var input = document.querySelector('#retina_image');
  ...
  if(curFiles.length === 0) {
    ...
    for(var i = 0; i < curFiles.length; i++) {
      ...
      if(validFileType(curFiles[i])) {
        ...
        preview1.replaceChild(image, preview1.childNodes[0]);
